...
\begin{enumerate}[nosep]
    \item per la legge ci sono alcuni vincoli numerici, dovendoci essere la certezza del diritto (es. 3000$\text{m}^2$, almeno $30\%$ di copertura,...) \textrightarrow{} sorge il dubbio su quale riferimento prendere (es. copertura delle chiome, da tronco a tronco);
    \item per il geografo può essere la ``superficie ricoperta da alberi'';
    \item per l'ecologo può essere ``l'ecosistema forestale nel quale l'ambiente è fortemente influenzato dalla presenza di alberi che cambiano la luce, il clima, la vegetazione,... rispetto all'esterno'';
...
\end{enumerate}
I ``servizi ecosistemici'' sono una PUTTANATA, creata da un economista per valutare il valore economico di un bosco. Per i forestali, i servizi ecosistemici sono legati alla quantità e qualità dei servizi e dei beni che un bosco restituisce.
\subsection{Le funzioni di un bosco}
Il bosco, di per sé, non possiede nessuna funzione; è l'uomo che ne attribuisce un certo valore.\\
...
\begin{enumerate}[nosep]
    ...
    \item ricreativa;
    \item produttiva;
    \item paesaggistica/paesistica;
    \item turistica;
    \item climatica;
    \item scientifica;
    \item ecologica;
    \item storico/culturale;
    \item sanitaria.
\end{enumerate}
\end{multicols}
...
\begin{enumerate}[nosep]
    ...
    Le prime leggi sulla gestione dei boschi (1200-1300), riguardavano i popolamenti da protezione diretta (chiamati anche boschi sacri o boschi banditi).\\
...
La funzione ecologica include sia la concezione ecosistemica che di biodiversità.\\
...
Gli alberi monumentali ``hanno avuto un culo della madonna'', poiché non sono stati soggetti a disturbi mortali per tutto il periodo della loro vita.
\subsubsection{Funzione di sink di carbonio}
È un concetto relativamente limitante, poiché dipende dalle condizioni del bosco. Se il popolamento cresce, avviene lo stoccaggio del carbonio; un bosco in stato di equilibrio invece ha alti consumi, che portano lo stoccaggio a zero.
\\[10pt]
...
Es. la gestione del bosco per la produzione di tavolame non porta a considerare la necromassa; invece, andrà tenuto conto quando si vuole considerare l'aspetto di biodiversità di quel popolamento. Infatti, il legno a terra non ha un fine produttivo.\\
