...
Queste per formazioni normalmente non sono veramente miste, ma sono dominate da una della specie che li compone.\\
Sono latifogli nobili, un tempo usate per lavori preziosi o utili (aceri strumenti musicali).\\
Gli aceri hanno un legno bianco indifferenziato , quasi setoso, servono per mobili, intarsi o strumenti musicali.\\
Il tiglio come legno è una specie buona : bianco indifferenziato, molto stabile, facilmente lavorabile e verniciabile (porte, finestre).\\
Queste specie sono mesofile (tollerano una certa quantità di ombra), vogliono suoli freschi/sciolti/profondi, si trovano normalmente nel piano collinare o basso montano; sono specie pioniere secondarie (nella faggeta se ci sono rari disturbi). Naturalmente si trovano nelle forre (umidi e ricchi).\\
Sono state utilizzate in arboricoltura da legno in centroeuropa; si trovavano spesso nei maggenghi, vicino alle cascine (soprattutto nel frassino). C'è stato l'abbandono della mezza montagna, queste specie hanno invaso (aceri e frassini).\\
Disseminazione anemocora, semi alati. \\
Ci sono molte aree di acerofrassineti di nuova formazione. Sono trovabili nell'area friulana vicino alla slovenia, comasco, varesotto, area a nord della valbelluna. \\
Sono formazioni composte da latifoglie nobili, sono anche popolazioni effimere (prima o poi sostituite da altro). Queste formazioni sono naturalmente fustaie, di neoformazione. Non possono essere ceduate (poichè sarebbe una conversione a ceduo, vietata in Italia).\\
Buona capacità pollonifera caulinare.\\
Non è possibile lasciare tutti questi popolamenti a acero-frassineti , dato il limitato mercato. Tutte le zone senza interesse economico possono essere portate verso le definitive (faggio o rovere).\\
In queste generazione, quei popolamenti possono essere utilizzati.\\
La selvicoltura può essere sia d'albero che di popolamento.\\
Con la selvicoltura di popolamento si deve arrivare alle 300-500 piante ad ha, con una serie di diradamenti. Sono stati fatti degli sfolli, risultati poi un fallimento: ridurre subito il popolamento, con una grande capacità di rinnovazione, porta il popolamento a ricostituirsi. In questi popolamenti è conveniente lasciare fare alla natura, e fare i diradamenti quando le piante sono alte 13-15 metri (il tempo di raggiungimento è diverso in base alla fertilità stazionale).\\
Il diradamento è sempre del tipo basso: lo si fa per rilasciare le piante migliori, essendo questo più semplice. Sarebbe meglio fare un diradamento libero (o selettivo), cioè che va a scegliere 300-500 candidati e li libera dall'eventuale competizione.\\
I diradamenti possono essere fatti secondo diversi criteri: geometrico (non scelta) o di scelta.\\
I diradamenti geometrici solitamente vengono fatti sui popolamenti artificiali. Il criterio di scelta viene utilizzato nei popolamenti naturali: può essere negativo o positivo (scelta delle piante brutte da eliminare o scelta delle piante belle da tenere). Il criterio negativo può essere dal basso, dall'alto o misto. Dal basso significa tagliare le piante perdenti delle competizione, dall'alto significa eliminare piante brutte del piano dominante (es. biforcate). Il criterio positivo significa scegliere le piante belle da portare a fine turno e tagliare le piante che generano la competizione (che sono belle, fossero brutte non andrebbero in competizione).\\
