...
\begin{figure}[htbp]
     ...
     \begin{subfigure}[b]{0.33\textwidth}
        ...
        \caption{Portamento di un Popolus nigra.}
     \end{subfigure}
     \hfill % Spazio elastico tra le immagini
     % Seconda Immagine
     \begin{subfigure}[b]{0.3\textwidth}
         ...
         \caption{Foglie di un Popolus nigra.}
     \end{subfigure}
     \hfill % Spazio elastico tra le immagini
     % Terza Immagine
     \begin{subfigure}[b]{0.33\textwidth}
         ...
         \caption{Foglie di un Popolus alba.}
     \end{subfigure}
...
In passato, nel carpineto avveniva una buca grossa, dando così alla farnia la possibilità di entrare e crescere.
\begin{figure}[htbp]
     \centering
     % Prima Immagine
     \begin{subfigure}[b]{0.33\textwidth}
