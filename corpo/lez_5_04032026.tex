...
\begin{itemize}
    \item boschi dei fiumi (formazioni ripariali): boschi delle aree fertili, senza ristagno idrico, falda freatica poco profonda;[DA RIVEDERE QUESTO ITEM]
    \item querco-carpineti e carpineti;
    \item boschi delle zone umide: anno-umneti.
\end{itemize}
\subsubsection{Anno-umneti}
...
Attualmente sta sopravvivendo come arbusto o come piccolo albero.\\
...
\end{itemize}
Queste specie richiedono molta umidità.\\
