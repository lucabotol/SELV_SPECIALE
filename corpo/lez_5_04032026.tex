...
\begin{itemize}[nosep]
    ...
    \item brucia in modo limitato, data la presenza di tannini all'interno.
\end{itemize}
...
Sono originari dell'Australia, dove sono presenti un centinaio di specie di eucalipti: colonizzano dalle aree costiere fino alle aree di montagna (da situazioni molto secche e calde fino alle situazioni umide).\\
...
I giovani polloni hanno foglie completamente diverse che da adulti: con una forma reniforme ed un colore verde glauco, vengono utilizzati per i mazzi di fiori.\\
...
Provengono dagli Stati della Carolina, Tennessee., Texas, con un clima simil mediterraneo
...
\begin{itemize}[nosep]
    ...
    \item boschi delle zone umide: alno-ulmeti.
\end{itemize}
\subsubsection{Alno-ulmeti}
...
In Italia sono quasi scomparse, date le notevoli bonifiche avvenute in passato: sono rimaste solamente in Piemonte e Lombardia (dove i suoli sono ricchi di argilla).
...
Il suo legno:
\begin{itemize}[nosep]
    \item è usato come legna da ardere, poiché non scoppietta;
...
Viene piantato con turni sui 30-40 anni, di difficile gestione pratica, perché l'area è paludosa e stagnante. Le utilizzazioni sono fatte d'inverno, mediante gru a cavo orizzontali.\\
