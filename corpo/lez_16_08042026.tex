...
L'accrescimento è estremamente lento, mettendoci fino a 100 anni per uscire dalla coltre nevosa: in questo periodo può essere attaccato dalle muffe presenti nelle nevi.\\
...
Non si fa selvicoltura con il cembro; normalmente si può estrarre dal bosco solamente gli individui danneggiati da disturbi naturali (e comunque lavorando sempre su tutto il collettivo).\\
...
\begin{figure}[htbp]
     ...
     \begin{subfigure}[b]{0.25\textwidth}
         \centering
         \includegraphics[width=\textwidth]{immagini/pino_cembro_portamento.jpeg}
        %\caption{}
     \end{subfigure}
     \hfill % Spazio elastico tra le immagini
     % Seconda Immagine
     \begin{subfigure}[b]{0.4\textwidth}
         \centering
         \includegraphics[width=\textwidth]{immagini/pino_cembro_foglie.jpeg}
        %\caption{}
     \end{subfigure}
     \hfill % Spazio elastico tra le immagini
     % Terza Immagine
     \begin{subfigure}[b]{0.33\textwidth}
         \centering
         \includegraphics[width=\textwidth]{immagini/pino_cembro_cono.jpeg}
        %\caption{}
     \end{subfigure}
    \caption{Pino cembro.}
     \label{fig:pino_cembro}
\end{figure}
...
\begin{itemize}[nosep]
    ...
    \item limite degli alberi (sotto forma di albero);
    \item limite del krummholz (``legno contorto''), limite degli alberi sotto forma di arbusti. 
\end{itemize}
