...
Ultimamente, soprattutto in pianura, si tende a fare il rimboschimento a gruppi, che va bene anche per i sottoimpianti. Solitamente, la rinnovazione è densa, e perciò si pianta il numero definitivo dei gruppi: ogni gruppo ha un numero finale di piantine (es. 8-12 cadauno).\\
...
\begin{itemize}[nosep]
    ...
    Anche in questo caso le piante sono 2000-2500 per ettaro. 
\end{itemize} 
