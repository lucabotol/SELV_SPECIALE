...
\end{enumerate}
\paragraph{Densità}
Può essere valutato secondo diversi parametri (piante ad ettaro, area basimetrica, volume,...).\\
Il numero di piante ad ettaro è un indicatore, ma non dice come è fatto un bosco
