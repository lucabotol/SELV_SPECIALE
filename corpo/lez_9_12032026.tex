...
\begin{itemize}
    ...
    \item il suo areale di temperatura è tra gli 11 e 13 gradi e pluviometrico superiori a 800 mm (con almeno 100 mm nel trimestre estivo);
...
In passato è stato ipotizzato di piantare il castagno cinese in Europa, che però non ha sapore; è perciò stato ibridito quello europeo con quello cinese, che però le castagne non sapevano da nulla lo stesso.\\
Le castagne non sono molto digeribili. I castagneti sono stati abbandonati, con solo l'uso delle caldarroste. \\
Pochi anni fa è tornata la moda, grazie alla tendenza del bio. Alcuni castagneti sono stati ripresi in mano.\\
Dove il suolo è pesante e umido, o dove è soggetto a forti variazioni del tasso di umidità, c'è un'altra malattia: mal dell'inchiostro.\\
Con questa malattia, la pianta muore molto velocemente, non ricacciando polloni.\\
Il legno di castagno è usato per paleria, travi, mobili, pali telegrafici.\\
Il legno di castagno è molto bello (simile alla rovere, meno giallo) e ha moltissimi tannini (anti crittogramo naturale): ha perciò una enorme durabilità, adatto per gli usi esterni (es. pali da vigna). Il tannino è contenuto molto nella corteccia e molto anche nel legno, veniva usato in passato per la concia delle pelli.\\
Il tannino è ignifugo, pertanto brucia male: non è una buona legna da ardere. Se si vuole bruciare, occorre lasciarlo all'acqua 3-5 anni, affinchè si dilavino i tannini.\\
Il legno di castagno è prodotto tendenzialmente da un ceduo: in teoria potrebbe essere semplice (senza rilascio di matricine, data l'elevata capacità pollonifera e l'elevata produzione di seme, che parte da 12-15 anni). Le matricine potrebbero servire a rimpiazziare le ceppaie che muoiono. I regolamenti forestali prescrivono la matricinatura, con minimo di 20-30 matricine (a seconda della Regione, il numero può cambiare). \\
