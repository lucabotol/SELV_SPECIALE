...
\begin{itemize}[nosep]
    ...
    \item possiede moltissimi tannini (è un anti-crittogramo naturale):
        \begin{enumerate}[nosep]
            ...
            \item essendo ignifugo, brucia male. Infatti, non si presta bene per la combustione (occorrerebbe lasciarlo all'acqua per 3-5 anni, affinchè si dilavino i tannini).
        \end{enumerate}
\end{itemize}
